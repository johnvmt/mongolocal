...
function MongoLocal(e){"undefined"!=typeof e&&null!==e||(e={}),this.config=e,this.collection="object"==typeof this.config.collection||Array.isArray(this.config.collection)?this.config.collection:{},this._cappedDocs=[]}var FauxMongo=require("fauxmongo"),ObjectId=require("objectid"),EventEmitter=require("wolfy87-eventemitter"),Utils=require("./Utils");MongoLocal.prototype.__proto__=EventEmitter.prototype,MongoLocal.prototype.find=function(){var e=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"projection",level:1,validate:function(e,t){return"object"==typeof e}},{name:"callback",level:0,validate:function(e,t){return"function"==typeof e}}]),t=[];try{this._findForEach(e.query,function(e){t.push(e)}),e.callback(null,t)}catch(t){e.callback(t,null)}},MongoLocal.prototype.insert=function(){function e(e,t){"function"==typeof n.callback&&n.callback(e,t)}function t(e){"undefined"==typeof e._id&&(e._id=ObjectId()),"function"==typeof o.config.insert?o.config.insert(e):Array.isArray(o.collection)?o.collection.push(e):o.collection[e._id]=e,o._cappedInsert(e._id),c.emit&&o.emit("insert",e)}var o=this,n=Utils.parseArgs(arguments,[{name:"docs",level:0,validate:function(e,t){return"object"==typeof e}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),c=Utils.objectMerge({emit:!0},n.options);try{Array.isArray(n.docs)?n.docs.forEach(t):t(n.docs),e(null,n.docs)}catch(t){e(t,null)}},MongoLocal.prototype._cloneObject=function(e){return JSON.parse(JSON.stringify(e))},MongoLocal.prototype.update=function(){function e(e){var t={};return Utils.objectForEach(e,function(e,o){"$set"==o?t.$set=Utils.objectMerge(t.$set,o):"$"==o.charAt(0)?t[o]=e:("object"==typeof t.$set&&null!=t.$set||(t.$set={}),t.$set[o]=e)}),t}var t=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"updateOperations",level:0,validate:function(e,t){return"object"==typeof e}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),o=Utils.objectMerge({emit:!0},t.options),n=e(t.updateOperations),c=this;this._findForEach(t.query,function(e,t){if(o.emit)var i=c._cloneObject(e);if("function"==typeof c.config.update){var r=c._updateDoc(e,n,!0);c.config.update(t,i,r)}else var r=c._updateDoc(e,n,!1);o.emit&&c.emit("update",i,r)}),"function"==typeof t.callback&&t.callback(null,!0)},MongoLocal.prototype.remove=function(){var e=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),t=Utils.objectMerge({emit:!0,justOne:!1},e.options),o=this;o._findForEach(e.query,function(e,n){if(t.emit)var c=o._cloneObject(e);var i=e._id;"function"==typeof o.config.remove?o.config.remove(n):Array.isArray(o.collection)?o.collection.splice(n,1):delete o.collection[n],t.emit&&o.emit("remove",c),o._cappedRemove(i)}),"function"==typeof e.callback&&e.callback(null,!0)},MongoLocal.prototype.isCapped=function(){return"number"==typeof this.config.max},MongoLocal.prototype._updateDoc=function(e,t,o){"boolean"==typeof o&&o&&(e=this._cloneObject(e));var n={};return Utils.objectForEach(t,function(t,o){"$"==o.charAt(0)?n[o]=t:e[o]=t}),FauxMongo.update(e,n),e},MongoLocal.prototype._findForEach=function(){function e(e,n){o._docFilter(e,t.query)&&t.callback(e,n)}var t=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e}},{name:"callback",level:0,validate:function(e,t){return"function"==typeof e}}]),o=this;if(Array.isArray(this.collection))t.query="string"==typeof t.query?{_id:t.query}:t.query,this.collection.forEach(e);else{try{t.query=={_id:t.query._id}&&(t.query=t.query._id)}catch(e){}"string"==typeof t.query?(this.collection[t.query],t.callback(this.collection[t.query],t.query)):Utils.objectForEach(this.collection,e)}},MongoLocal.prototype._docFilter=function(e,t){return FauxMongo.matchQuery(e,t)},MongoLocal.prototype._cappedInsert=function(e){if(this.isCapped())for(this._cappedDocs.push(e);this._cappedDocs.length>this.config.max;)this.remove(this._cappedDocs.shift(),!0)},MongoLocal.prototype._cappedRemove=function(e){var t=this._cappedDocs.indexOf(e);t>=0&&this._cappedDocs.splice(t,0)},module.exports=function(e){return new MongoLocal(e)};
},{"./Utils":30,"fauxmongo":4,"objectid":23,"wolfy87-eventemitter":28}],30:[function(require,module,exports){
