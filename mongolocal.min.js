...
function MongoLocal(e){"undefined"!=typeof e&&null!==e||(e={}),this.config=e,this.collection="object"==typeof this.config.collection||Array.isArray(this.config.collection)?this.config.collection:{},this._cappedDocs=IndexedLinkedList()}var FauxMongo=require("fauxmongo"),ObjectId=require("objectid"),EventEmitter=require("wolfy87-eventemitter"),Utils=require("./Utils"),IndexedLinkedList=require("./IndexedLinkedList");MongoLocal.prototype.__proto__=EventEmitter.prototype,MongoLocal.prototype.find=function(){var e=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"projection",level:1,validate:function(e,t){return"object"==typeof e}},{name:"callback",level:0,validate:function(e,t){return"function"==typeof e}}]),t=[];try{this._findForEach(e.query,function(e){t.push(e)}),e.callback(null,t)}catch(t){e.callback(t,null)}},MongoLocal.prototype.findOne=function(){var e=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"projection",level:1,validate:function(e,t){return"object"==typeof e}},{name:"callback",level:0,validate:function(e,t){return"function"==typeof e}}]),t={},o=void 0;try{this._findForEach(e.query,function(e){throw o=e,t})}catch(n){n==t?e.callback(null,o):e.callback(n,null)}},MongoLocal.prototype.insert=function(){function e(e,t){"function"==typeof n.callback&&n.callback(e,t)}function t(e){"undefined"==typeof e._id&&(e._id=ObjectId()),"function"==typeof o.config.insert?o.config.insert(e):Array.isArray(o.collection)?o.collection.push(e):o.collection[e._id]=e,o._cappedInsert(e._id,i.emitCascade),i.emit&&o.emit("insert",e)}var o=this,n=Utils.parseArgs(arguments,[{name:"docs",level:0,validate:function(e,t){return"object"==typeof e}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),i=Utils.objectMerge({emit:!0},n.options);i=Utils.objectMerge({emitCascade:i.emit},i);try{Array.isArray(n.docs)?n.docs.forEach(t):t(n.docs),e(null,n.docs)}catch(t){e(t,null)}},MongoLocal.prototype._cloneObject=function(e){return JSON.parse(JSON.stringify(e))},MongoLocal.prototype.update=function(){var e=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"updateOperations",level:0,validate:function(e,t){return"object"==typeof e}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),t=Utils.objectMerge({emit:!0,multi:!1},e.options);t=Utils.objectMerge({emitCascade:t.emit},t);var o=this._validateUpdate(e.updateOperations);if(!t.multi)var n={};var i=this;try{this._findForEach(e.query,function(e,c){if(t.emit)var a=i._cloneObject(e);if("function"==typeof i.config.update){var r=i._updateDoc(e,o,!0);i.config.update(c,a,r)}else var r=i._updateDoc(e,o,!1);if(t.emit&&i.emit("update",a,r,o,t),!t.multi)throw n})}catch(e){if(e!==n)throw e}"function"==typeof e.callback&&e.callback(null,!0)},MongoLocal.prototype.remove=function(){var e=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),t=Utils.objectMerge({emit:!0,justOne:!1},e.options);t=Utils.objectMerge({emitCascade:t.emit},t);var o=this;o._findForEach(e.query,function(e,n){if(t.emit)var i=o._cloneObject(e);var c=e._id;"function"==typeof o.config.remove?o.config.remove(n):Array.isArray(o.collection)?o.collection.splice(n,1):delete o.collection[n],t.emit&&o.emit("remove",i),o._cappedRemove(c)}),"function"==typeof e.callback&&e.callback(null,!0)},MongoLocal.prototype.isCapped=function(){return"number"==typeof this.config.max},MongoLocal.prototype._validateUpdate=function(e){var t={};return Utils.objectForEach(e,function(e,o){"$set"==o?t.$set=Utils.objectMerge(t.$set,o):"$"==o.charAt(0)?t[o]=e:("object"==typeof t.$set&&null!=t.$set||(t.$set={}),t.$set[o]=e)}),t},MongoLocal.prototype._updateDoc=function(e,t,o){"boolean"==typeof o&&o&&(e=this._cloneObject(e));var n={};return Utils.objectForEach(t,function(t,o){"$"==o.charAt(0)?n[o]=t:e[o]=t}),FauxMongo.update(e,n),e},MongoLocal.prototype._findForEach=function(){function e(e,n){o._docFilter(e,t.query)&&t.callback(e,n)}var t=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e}},{name:"callback",level:0,validate:function(e,t){return"function"==typeof e}}]),o=this;if(Array.isArray(this.collection))t.query="string"==typeof t.query?{_id:t.query}:t.query,this.collection.forEach(e);else{try{"object"==typeof t.query&&1==Object.keys(t.query).length&&"undefined"!=typeof t.query._id&&(t.query=t.query._id)}catch(e){}"string"==typeof t.query?(this.collection[t.query],t.callback(this.collection[t.query],t.query)):Utils.objectForEach(this.collection,e)}},MongoLocal.prototype._docFilter=function(e,t){return FauxMongo.matchQuery(e,t)},MongoLocal.prototype._cappedInsert=function(e,t){if("boolean"!=typeof t&&(t=!0),this.isCapped())for(this._cappedDocs.push(e,e);this._cappedDocs.length>this.config.max;)this.remove(this._cappedDocs.dequeue(),{emit:t})},MongoLocal.prototype._cappedRemove=function(e){try{this._cappedDocs.remove(e)}catch(e){if("undefined_item"!=e.message)throw e}},module.exports=function(e){return new MongoLocal(e)};
