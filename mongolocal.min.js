...
function MongoLocal(e){"undefined"!=typeof e&&null!==e||(e={}),this.config=e,this.collection="object"==typeof this.config.collection||Array.isArray(this.config.collection)?this.config.collection:{},this._cappedDocs=[]}var Utils=require("./Utils"),fauxmongo=require("fauxmongo"),objectid=require("objectid");MongoLocal.prototype.find=function(){var e=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"projection",level:1,validate:function(e,t){return"object"==typeof e}},{name:"callback",level:0,validate:function(e,t){return"function"==typeof e}}]),t=[];try{this._findForEach(e.query,function(e){t.push(e)}),e.callback(null,t)}catch(t){e.callback(t,null)}},MongoLocal.prototype.insert=function(){function e(e,t){"function"==typeof n&&n(e,t)}function t(e){"undefined"==typeof e._id&&(e._id=objectid()),"function"==typeof c.config.insert?c.config.insert(e):Array.isArray(c.collection)?c.collection.push(e):c.collection[e._id]=e,c._cappedInsert(e._id)}var o=arguments[0];if(2==arguments.length)var n=arguments[1];else if(3==arguments.length)var n=(arguments[1],arguments[2]);var c=this;try{Array.isArray(o)?o.forEach(t):t(o),e(null,o)}catch(t){e(t,null)}},MongoLocal.prototype.update=function(){function e(e){var t={};return Utils.objectForEach(e,function(e,o){"$set"==o?t.$set=Utils.objectMerge(t.$set,o):"$"==o.charAt(0)?t[o]=e:("object"==typeof t.$set&&null!=t.$set||(t.$set={}),t.$set[o]=e)}),t}var t=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"updateOperations",level:0,validate:function(e,t){return"object"==typeof e}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),o=e(t.updateOperations),n=this;this._findForEach(t.query,function(e,t){"function"==typeof n.config.update?n.config.update(t,n._updateDoc(e,o,!0)):n._updateDoc(e,o,!1)}),"function"==typeof t.callback&&t.callback(null,!0)},MongoLocal.prototype.remove=function(){var e=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"justOne",level:1,validate:function(e,t){return"boolean"==typeof e}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),t=this;t._findForEach(e.query,function(e,o){var n=e._id;"function"==typeof t.config.remove?t.config.remove(o):Array.isArray(t.collection)?t.collection.splice(o,1):delete t.collection[o],t._cappedRemove(n)}),"function"==typeof e.callback&&e.callback(null,!0)},MongoLocal.prototype.isCapped=function(){return"number"==typeof this.config.max},MongoLocal.prototype._updateDoc=function(e,t,o){"boolean"==typeof o&&o&&(e=JSON.parse(JSON.stringify(e)));var n={};return Utils.objectForEach(t,function(t,o){"$"==o.charAt(0)?n[o]=t:e[o]=t}),fauxmongo.update(e,n),e},MongoLocal.prototype._findForEach=function(){function e(e,n){o._docFilter(e,t.query)&&t.callback(e,n)}var t=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e}},{name:"callback",level:0,validate:function(e,t){return"function"==typeof e}}]),o=this;if(Array.isArray(this.collection))t.query="string"==typeof t.query?{_id:t.query}:t.query,this.collection.forEach(e);else{try{t.query=={_id:t.query._id}&&(t.query=t.query._id)}catch(e){}"string"==typeof t.query?(this.collection[t.query],t.callback(this.collection[t.query],t.query)):Utils.objectForEach(this.collection,e)}},MongoLocal.prototype._docFilter=function(e,t){return fauxmongo.matchQuery(e,t)},MongoLocal.prototype._cappedInsert=function(e){if(this.isCapped())for(this._cappedDocs.push(e);this._cappedDocs.length>this.config.max;)this.remove(this._cappedDocs.shift(),!0)},MongoLocal.prototype._cappedRemove=function(e){var t=this._cappedDocs.indexOf(e);t>=0&&this._cappedDocs.splice(t,0)},module.exports=MongoLocal;
},{"./Utils":29,"fauxmongo":4,"objectid":23}],29:[function(require,module,exports){
...
var MongoLocal=require("./MongoLocal");module.exports=function(o){return new MongoLocal(o)};
},{"./MongoLocal":28}]},{},[30])(30)
});
