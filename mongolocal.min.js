(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.mongolocal = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var $3_BITS=16777215,$5_BITS=0xffffffffff,MACHINE_ID_AND_PID=Math.round(Math.random()*$5_BITS),index=0,Index=function(){return index+=1%$3_BITS},Timestamp=function(){return Math.floor(new Date/1e3)},pad=function(t,n){for(;t.length<n;)t="0"+t;return t},makeObjectId=function(){var t=[[Timestamp(),8],[MACHINE_ID_AND_PID,10],[Index(),6]],n=t.reduce(function(t,n){return t+pad(n[0].toString(16),n[1])},"");return n},objIdPattern=/^[0-9a-fA-F]{24}$/,isValid=function(t){return!!t&&"function"==typeof t.toString&&objIdPattern.test(t.toString())};module.exports=makeObjectId,module.exports.isValid=isValid;
...
function IndexedLinkedList(){this._list={},this.length=0,this.head=null,this.tail=null}IndexedLinkedList.prototype.dequeue=function(){return this._removeItem(this.head)},IndexedLinkedList.prototype.remove=function(e){this._removeItem(this._list[e])},IndexedLinkedList.prototype.push=function(e,t){var n=this._resetIndex(e,t);n.prev=null,n.next=this.head,this.head=n,this.length++},IndexedLinkedList.prototype.enqueue=function(e,t){var n=this._resetIndex(e,t);n.next=null,n.prev=this.tail,this.tail=n,this.length++},IndexedLinkedList.prototype._resetIndex=function(e,t){try{this.remove(e)}catch(e){}return this._set(e,t)},IndexedLinkedList.prototype._set=function(e,t){return"object"==typeof this._list[e]?this._list[e].data=t:this._list[e]={data:t,next:void 0,prev:void 0},this._list[e]},IndexedLinkedList.prototype._removeItem=function(e){if("object"!=typeof e||null==e)throw new Error("undefined_item");return null==e.next?this.tail=e.prev:e.next.prev=e.prev,null==e.prev?this.head=e.next:e.prev.next=e.next,this.length--,e.data},module.exports=function(){return new IndexedLinkedList};
},{}],30:[function(require,module,exports){
function MongoLocal(e){"undefined"!=typeof e&&null!==e||(e={}),this.config=e,this.collection="object"==typeof this.config.collection||Array.isArray(this.config.collection)?this.config.collection:{},this._cappedDocs=IndexedLinkedList()}var FauxMongo=require("fauxmongo"),ObjectId=require("objectid"),EventEmitter=require("wolfy87-eventemitter"),Utils=require("./Utils"),IndexedLinkedList=require("./IndexedLinkedList");MongoLocal.prototype.__proto__=EventEmitter.prototype,MongoLocal.prototype.find=function(){var e=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"projection",level:1,validate:function(e,t){return"object"==typeof e}},{name:"callback",level:0,validate:function(e,t){return"function"==typeof e}}]),t=[];try{this._findForEach(e.query,function(e){t.push(e)}),e.callback(null,t)}catch(t){e.callback(t,null)}},MongoLocal.prototype.findOne=function(){var e=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"projection",level:1,validate:function(e,t){return"object"==typeof e}},{name:"callback",level:0,validate:function(e,t){return"function"==typeof e}}]),t={},o=void 0;try{this._findForEach(e.query,function(e){throw o=e,t}),e.callback(null,null)}catch(n){n==t?e.callback(null,o):e.callback(n,null)}},MongoLocal.prototype.insert=function(){function e(e,t){"function"==typeof i.callback&&i.callback(e,t)}function t(e){"undefined"==typeof e._id?(e._id=ObjectId(),o(e)):n.findOne({_id:e._id},function(t,n){if(t)throw new Error("find_error");if(null!=n)throw new Error("id_exists");o(e)})}function o(e){"function"==typeof n.config.insert?n.config.insert(e):Array.isArray(n.collection)?n.collection.push(e):n.collection[e._id]=e,n._cappedInsert(e._id,c.emitCascade),c.emit&&n.emit("insert",e,c)}var n=this,i=Utils.parseArgs(arguments,[{name:"docs",level:0,validate:function(e,t){return"object"==typeof e}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),c=Utils.objectMerge({emit:!0},i.options);c=Utils.objectMerge({emitCascade:c.emit},c);try{Array.isArray(i.docs)?i.docs.forEach(t):t(i.docs),e(null,i.docs)}catch(t){e(t,null)}},MongoLocal.prototype._cloneObject=function(e){return JSON.parse(JSON.stringify(e))},MongoLocal.prototype.update=function(){var e=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"updateOperations",level:0,validate:function(e,t){return"object"==typeof e}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),t=this,o=Utils.objectMerge({emit:!0,multi:!1,upsert:!1},e.options);o=Utils.objectMerge({emitCascade:o.emit},o);var n=t._validateQuery(e.query),i=this._validateUpdate(e.updateOperations);if(!o.multi)var c={};try{var a=0;if(this._findForEach(e.query,function(e,n){if(a++,o.emit)var l=t._cloneObject(e);if("function"==typeof t.config.update){var r=t._updateDoc(e,i,!0);t.config.update(n,l,r)}else var r=t._updateDoc(e,i,!1);if(o.emit&&t.emit("update",l,r,i,o),!o.multi)throw c}),!a&&o.upsert){var l={};"undefined"!=typeof n._id&&(l._id=n._id),FauxMongo.update(l,i);var r=t._cloneObject(o);r.emit=r.emitCascade,t.insert(l,r,e.callback)}}catch(e){if(e!==c)throw e}"function"==typeof e.callback&&a&&!o.upsert&&e.callback(null,!0)},MongoLocal.prototype.remove=function(){var e=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),t=Utils.objectMerge({emit:!0,justOne:!1},e.options);t=Utils.objectMerge({emitCascade:t.emit},t);var o=this,n=o._validateQuery(e.query);o._findForEach(n,function(e,n){if(t.emit)var i=o._cloneObject(e);var c=e._id;"function"==typeof o.config.remove?o.config.remove(n):Array.isArray(o.collection)?o.collection.splice(n,1):delete o.collection[n],t.emit&&o.emit("remove",i,t),o._cappedRemove(c)}),"function"==typeof e.callback&&e.callback(null,!0)},MongoLocal.prototype.isCapped=function(){return"number"==typeof this.config.max},MongoLocal.prototype._validateUpdate=function(e){var t={};return Utils.objectForEach(e,function(e,o){"$set"==o?t.$set=Utils.objectMerge(t.$set,e):"$"==o.charAt(0)?t[o]=e:("object"==typeof t.$set&&null!=t.$set||(t.$set={}),t.$set[o]=e)}),t},MongoLocal.prototype._validateQuery=function(e){return"object"!=typeof e?{_id:e}:e},MongoLocal.prototype._updateDoc=function(e,t,o){"boolean"==typeof o&&o&&(e=this._cloneObject(e));var n={};return Utils.objectForEach(t,function(t,o){"$"==o.charAt(0)?n[o]=t:e[o]=t}),FauxMongo.update(e,n),e},MongoLocal.prototype._findForEach=function(){function e(e,i){o._docFilter(e,n)&&t.callback(e,i)}var t=Utils.parseArgs(arguments,[{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e}},{name:"callback",level:0,validate:function(e,t){return"function"==typeof e}}]),o=this,n=o._validateQuery(t.query);Array.isArray(this.collection)?this.collection.forEach(e):1==Object.keys(n).length&&"undefined"!=typeof n._id?(this.collection[n._id],t.callback(this.collection[n._id],n._id)):Utils.objectForEach(this.collection,e)},MongoLocal.prototype._docFilter=function(e,t){return FauxMongo.matchQuery(e,t)},MongoLocal.prototype._cappedInsert=function(e,t){if("boolean"!=typeof t&&(t=!0),this.isCapped())for(this._cappedDocs.push(e,e);this._cappedDocs.length>this.config.max;)this.remove(this._cappedDocs.dequeue(),{emit:t})},MongoLocal.prototype._cappedRemove=function(e){try{this._cappedDocs.remove(e)}catch(e){if("undefined_item"!=e.message)throw e}},module.exports=function(e){return new MongoLocal(e)};
},{"./IndexedLinkedList":29,"./Utils":31,"fauxmongo":4,"objectid":23,"wolfy87-eventemitter":28}],31:[function(require,module,exports){
